...
public class AsyncTaskGCM extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        String gcm_url = "http://192.168.99.1/cgi-bin/gcm_register.pl"; //TODO: Add PHP(Write) URL here.
        //String gcm_url = "http://172.19.17.58/cgi-bin/koha/gcm_register.pl"; //TODO: Add PHP(Write) URL here.
